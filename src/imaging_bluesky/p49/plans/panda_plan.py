...
from ophyd_async.core import DetectorTrigger, FlyMotorInfo, TriggerInfo
...
def fly_scan(
    ...
    panda_pcomp = StaticPcompFlyableLogic(panda.pcomp[1])
    ...
    def inner_plan():
        ...
        panda_pcomp_info = PcompInfo(
            start_position=ceil(start_pos / abs(MRES)),
            pulse_width=1,
        ...
        yield from bps.prepare(flyer, panda_pcomp_info, wait=True)
